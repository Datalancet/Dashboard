...
import SteplineAreaChartWithTable from "../SteplineAreaChartwithTable";
import html2canvas from "html2canvas";
import { useSearchParams } from 'next/navigation';

const SteplineAreaChart = () => {
  const searchParams = useSearchParams();
  const projectId = searchParams.get('projectId') || 'default';
  const chartType = 'SteplineAreachart';
  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-4">
        <Breadcrumb pageName="Stepline Area Chart" />
      </div>
      
      <div className="flex">
        <div className="w-3/4" ref={chartRef}>
          <SteplineAreaChartWithTable
