...
import MonochromepieChartWithTable from "../MonochromepieChartwithTable";
...
const Monochromepie = () => {
  ...
  const chartType = 'Monochromepie'; // This identifies the chart type
  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-4">
        <Breadcrumb pageName="Monochrome Pie Chart" />
      </div>
      
      <div className="flex">
        <div className="w-3/4" ref={chartRef}>
        <MonochromepieChartWithTable
            design={design}
            color={color}
