      ...
      <div className="grid grid-cols-1 gap-9 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3">
        <div className="flex flex-col gap-9">
          <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            <div onClick={() => saveChartType('line-chart')} className="cursor-pointer">
              <img className="rounded-t-lg" src="/images/chart/line.png" alt="Line Chart" />
            </div>
            <div className="p-5">
        ...
        <div className="flex flex-col gap-9">
          <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            <div onClick={() => saveChartType('spline-chart')} className="cursor-pointer">
              <img className="rounded-t-lg" src="/images/chart/spline.png" alt="Spline Chart" />
            </div>
            <div className="p-5">
              <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                Spline Chart
        ...
        <div className="flex flex-col gap-9">
          <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            <div onClick={() => saveChartType('stepline-chart')} className="cursor-pointer">
              <img className="rounded-t-lg" src="/images/chart/stepline.png" alt="Stepline Chart" />
            </div>
            <div className="p-5">
              <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                Stepline Chart
