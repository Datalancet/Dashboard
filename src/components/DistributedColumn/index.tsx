...
import DistributedColumnChartWithTable from "../DistributedColumnChartwithTable";
...
const DistributedColumnChart = () => {
  ...
  const chartType = 'DistributedColumn'; // This identifies the chart type
  ...
  }, [design, isGridMode, gridVariation, isLabelStyle, labelPosition, xAxisPosition, yAxisPosition, titleAlignment, sourceName, sourceURL, valuesPosition, chartTitle, color, seriesNames, xAxisTitle, yAxisTitle, projectId, chartType, logoPosition, logoUrl,showPercentages,showColorOptions]);
  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-4">
        <Breadcrumb pageName="Distributed Column Chart" />
      </div>
      
      <div className="flex">
        <div className="w-3/4" ref={chartRef}>
        <DistributedColumnChartWithTable
            design={design}
            colors={colors}
