...
interface SplineAreaChartWithTableProps {
  lineColors: string[];
...
const SplineAreaChartWithTable: React.FC<SplineAreaChartWithTableProps> = ({
  lineColors,
  titleAlignment,
  sourceName,
  sourceURL,
...
export default SplineAreaChartWithTable;