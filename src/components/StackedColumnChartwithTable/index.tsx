...
interface StackedColumnChartWithTableProps {
  design: string;
  colors: string[];
...
const StackedColumnChartWithTable: React.FC<StackedColumnChartWithTableProps> = ({
  design,
  colors,
  gridVariation,
  xAxisPosition,
...
export default StackedColumnChartWithTable;