...
import GradientDonutChartWithTable from "../GradientDonutChartwithTable";
...
const GradientDonutChart = () => {
  ...
  const chartType = 'GradientDonut'; // This identifies the chart type
  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-4">
        <Breadcrumb pageName="Gradient Donut Chart" />
      </div>
      
      <div className="flex">
        <div className="w-3/4" ref={chartRef}>
        <GradientDonutChartWithTable
            design={design}
            color={color}
