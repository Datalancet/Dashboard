...
import SplineAreaChartWithTable from "../SplineAreaChartwithTable";
...
const SplineAreaChart = () => {
  ...
  const chartType = 'SplineAreachart';
  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-4">
        <Breadcrumb pageName="Spline Area Chart" />
      </div>
      
      <div className="flex">
        <div className="w-3/4" ref={chartRef}>
          <SplineAreaChartWithTable
